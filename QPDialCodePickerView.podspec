#
#  Be sure to run `pod spec lint QPDialCodePickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "pcjbird"
  # s.authors            = { "pcjbird" => "pcjbird@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/pcjbird"
  ...
  s.source       = { :git => "https://github.com/pcjbird/QPDialCodePickerView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "QPDialCodePickerView/QPDialCodePickerView", "QPDialCodePickerView/QPDialCodePickerView/**/*.{h,m}"
